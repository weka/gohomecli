...
const (
	clusterCIDRIP4 = "10.42.0.0/16"
	clusterCIDRIP6 = "2001:cafe:42::/56"
	serviceCIDRIP4 = "10.43.0.0/16"
	serviceCIDRIP6 = "2001:cafe:43::/112"
)

var openNetworks = []string{
	clusterCIDRIP4, // pods
	clusterCIDRIP6, // pods
	serviceCIDRIP4, // services
	serviceCIDRIP6, // services
}
